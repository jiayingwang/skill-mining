...
class Rake(object):
    ...
    def extract_keywords_from_sentences(self, sentences):
        ...
        self._build_frequency_dist(phrase_set)
        print('done')
        print('build degree...', end='', flush=True)
        self._build_word_co_occurance_graph(phrase_set)
        print('done')
        print('build rank...', end='', flush=True)
        self._build_ranklist(phrase_set)
        print('done')
    ...
    def generate_phrases(self, sentence):
        ...
        :param sentence:  a sentence which forms the text.
        :return: list of string tuples where each tuple is a collection
